...
import dashboardImg from '../public/assets/projects/admin-dashboard.png';
    ...
    <div className='w-full'>
        ...
        <div className='max-w-[1240px] mx-auto p2 grid md:grid-cols-5 gap-8 pt-8'>
            <div className='col-span-4'>
                ...
                <h2>Overview</h2>
                <p>
                I built this app to practice react.js and tailwind skills. 
                This application is about how to build admin dashboard UI using react.js, tailwing and synfusion.
                </p>
                <button  className='px-8 py-2 mt-4 mr-3'>
                <a href='https://admin-dashboard-ebon-seven.vercel.app/' target="_blank" rel='noreferrer'>Demo</a>
                </button>
                <button className='px-8 py-2 mt-4'>
                <a href='https://github.com/mabrursatori/react-dahsboard' target="_blank" rel='noreferrer' >Code</a>
                </button>
