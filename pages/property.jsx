    ...
    <div className='w-full'>
        ...
        <div className='max-w-[1240px] mx-auto p2 grid md:grid-cols-5 gap-8 pt-8'>
            <div className='col-span-4'>
                ...
                <h2>Overview</h2>
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, nesciunt aliquid! Sit recusandae rerum vitae sunt, quaerat quod veritatis blanditiis ipsum nostrum consequuntur doloremque eum, officiis voluptatum maiores cum minus sint eius reprehenderit tempora iure dolor iste deleniti nobis expedita! Cupiditate, tempora et?
                </p>
